...
<ul class="nav nav-pills nav-fill">
	<li class="nav-item">
		<a class="nav-link active" href="index.php">00:00</a>
	</li>
	<li class="nav-item">
		<a class="nav-link" href="index1.php">12:00</a>
	</li>
	<li class="nav-item">
		<a class="nav-link" href="index2.php">13:00</a>
	</li>
	<li class="nav-item">
		<a class="nav-link" href="index3.php">20:00</a>
	</li>
</ul>

<!-- perhitungan diskon (untuk data training-->
<?php
// date_default_timezone_set('Asia/Jakarta');
// $time = date('H:i');
// $bottom = "00:00";
// $up = "11:59";
// if ($time > "$bottom" && $time < "$up") {
...
feedForwardBaju1(81, 82, 83, 85, 80, $bx1h1n, $bx2h1n, $bx3h1n, $bx4h1n, $bx1h2n, $bx2h2n, $bx3h2n, $bx4h2n, $bbiash1n, $bbiash2n, $bh1n, $bh2n, $bbiason);
$dbaju1 = round($dnf);
//Baju2
...
feedForwardBaju2(1, 46, 53, 54, 19, $bx1h1n, $bx2h1n, $bx3h1n, $bx4h1n, $bx1h2n, $bx2h2n, $bx3h2n, $bx4h2n, $bbiash1n, $bbiash2n, $bh1n, $bh2n, $bbiason);
$dbaju2 = round($dnf);
